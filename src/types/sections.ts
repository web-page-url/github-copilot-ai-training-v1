...
export const sections: Section[] = [
  {
    ...
    description: "Introduction to AI pair programming",
    difficulty: "beginner",
    questionsCount: 2,
    estimatedTime: "5 min",
    icon: "🤖",
  ...
  {
    id: 2,
    title: "Copilot Features & Plans",
    description: "Pricing and subscription options",
    difficulty: "beginner", 
    questionsCount: 2,
    estimatedTime: "5 min",
    icon: "💡",
    color: "from-green-500 to-emerald-500",
    slug: "copilot-features-plans",
    is_active: true
  },
  {
    id: 3,
    ...
    slug: "vs-code-integration",
    is_active: true
  },
  {
    id: 4,
    title: "Code Suggestions",
    description: "How Copilot generates suggestions",
    difficulty: "intermediate",
    questionsCount: 2,
    estimatedTime: "5 min",
    icon: "💭",
  ...
  },
  {
    ...
    description: "React, Node.js, Python support",
    difficulty: "advanced",
    questionsCount: 2,
    estimatedTime: "5 min",
    icon: "🔗",
