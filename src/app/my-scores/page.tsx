    ...
    if (userInfo?.email) {
      ...
      if (meetsCurrentRequirements) {
        ...
        console.log('❌ Master certificate requirements NOT met:', { 
          ...
          needsSections: totalSections < 10, // Updated to 10 sections
                    ...
                    <div className="flex items-center justify-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg text-gray-600 dark:text-gray-300">
                                                      {overallStats.totalSectionsCompleted >= 10 && overallStats.overallAccuracy >= 60
                            ? `Congratulations! You've mastered all 10 sections with ${overallStats.overallAccuracy}% accuracy!` 
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border border-blue-200/50 dark:border-blue-700/50">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-6">
                      Complete all 10 sections with 60%+ overall accuracy to earn your GitHub Copilot Master Certificate
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                      ...
                      <div className="bg-white/70 dark:bg-gray-800/70 rounded-lg p-4">
                        ...
                        <div className={`text-lg font-bold ${
                                                      overallStats.totalSectionsCompleted >= 10 ? 'text-green-600' : 'text-blue-600'
                        }`}>
                          {overallStats.totalSectionsCompleted}/10 Sections
                        </div>
                ...
                <div className={`p-4 rounded-lg border-2 ${overallStats.totalSectionsCompleted >= 10 && overallStats.overallAccuracy >= 60 ? 'border-green-500 bg-green-50 dark:bg-green-900/20' : 'border-gray-300 bg-gray-50 dark:bg-gray-700'}`}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-300">Complete all 10 sections + 60% accuracy</div>
                    </div>
                  </div>
                </div>
              </div>
